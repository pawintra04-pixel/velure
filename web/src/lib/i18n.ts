...
export const bookingsText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    payUnpaid: "Not paid yet",
    payDeposit: "Deposit paid",
    payFree: "No charge",
    depositAmountPlaceholder: "Deposit amount (฿)",
    paymentNotePlaceholder: "Payment note (optional, e.g. complimentary)",
    outstanding: "Owes",
    markPaid: "Payment received",
    markPaidTitle: "Mark this booking as fully paid?",
    markPaidDesc: "Records that the customer has paid the remaining amount in person.",
    goBack: "Go back",
    saving: "Saving…",
  ...
  th: {
    ...
    payPaid: "จ่ายครบแล้ว",
    payUnpaid: "ยังไม่จ่าย",
    payDeposit: "จ่ายมัดจำแล้ว",
    payFree: "ไม่คิดเงิน",
    depositAmountPlaceholder: "ยอดมัดจำ (บาท)",
    paymentNotePlaceholder: "หมายเหตุการชำระเงิน (ไม่บังคับ เช่น complimentary)",
    outstanding: "ค้างชำระ",
    markPaid: "รับเงินครบแล้ว",
    markPaidTitle: "บันทึกว่าการจองนี้ชำระครบแล้วหรือไม่?",
    markPaidDesc: "ระบบจะบันทึกว่าลูกค้าจ่ายยอดที่เหลือครบแล้วที่หน้าร้าน",
    goBack: "กลับ",
    saving: "กำลังบันทึก…",
    paidSoFar: "จ่ายแล้ว",
  },
...
export const calendarText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    changeTeacher: "Teacher for this session only",
    changeTeacherButton: "Change teacher",
    changeTeacherTitle: "Change the teacher for this one session?",
    changeTeacherDesc: "Only this date changes — other sessions in the series keep their usual teacher. Attendees' bookings move to the new teacher too, so reports credit whoever actually taught.",
    changing: "Changing…",
    goBack: "Go back",
    closePopup: "Close",
  ...
  th: {
    ...
    changeTeacher: "ครูผู้สอนเฉพาะรอบนี้",
    changeTeacherButton: "เปลี่ยนครู",
    changeTeacherTitle: "เปลี่ยนครูเฉพาะรอบนี้หรือไม่?",
    changeTeacherDesc: "เปลี่ยนเฉพาะวันนี้เท่านั้น รอบอื่นในชุดเดียวกันยังเป็นครูคนเดิม การจองของผู้เรียนในรอบนี้จะย้ายไปอยู่กับครูคนใหม่ด้วย เพื่อให้รายงานสิ้นเดือนนับให้คนที่สอนจริง",
...
export const servicesText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    deleteServiceDesc: "This removes the service from your booking page and unassigns it from staff. Services with any booking, class or package history — including past or cancelled bookings — can't be deleted, to keep existing reports accurate.",
    removeFieldTitle: "Remove this question?",
    removeFieldDesc: "Customers won't be asked this question on new bookings. Answers already given on past bookings are removed too.",
    removePackageTitle: "Stop selling this package?",
    removePackageDesc: "It will no longer be offered for sale. Customers who already bought it keep their remaining sessions.",
  },
  th: {
    title: "บริการ",
    ...
    deleting: "กำลังลบ…",
    removing: "กำลังลบ…",
    deleteServiceTitle: "ลบบริการนี้หรือไม่?",
    deleteServiceDesc: "บริการนี้จะหายไปจากหน้าจองและถูกถอดออกจากพนักงานทุกคน บริการที่เคยมีการจอง คลาส หรือแพ็กเกจมาก่อน (รวมถึงการจองที่ผ่านไปแล้วหรือถูกยกเลิก) จะลบไม่ได้ เพื่อให้รายงานเดิมยังถูกต้อง",
    removeFieldTitle: "ลบคำถามนี้หรือไม่?",
    removeFieldDesc: "ลูกค้าที่จองใหม่จะไม่เห็นคำถามนี้อีก และคำตอบที่เคยกรอกไว้ในการจองเก่าจะถูกลบไปด้วย",
    removePackageTitle: "เลิกขายแพ็กเกจนี้หรือไม่?",
    removePackageDesc: "แพ็กเกจนี้จะไม่ถูกเสนอขายอีก ลูกค้าที่ซื้อไปแล้วยังใช้สิทธิ์ที่เหลือได้ตามปกติ",
  },
};
...
export const teamText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    goBack: "Go back",
    removing: "Removing…",
    removeBlockTitle: "Remove this blocked time?",
    removeBlockDesc: "This staff member will show as available again during this time, and customers will be able to book it.",
  },
  th: {
    title: "พนักงาน",
    ...
    goBack: "กลับ",
    removing: "กำลังลบ…",
    removeBlockTitle: "ลบช่วงเวลาไม่ว่างนี้หรือไม่?",
    removeBlockDesc: "พนักงานคนนี้จะกลับมาว่างในช่วงเวลานี้ และลูกค้าจะจองช่วงนี้ได้",
  },
};
...
export const classesText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    nextSession: "Next",
    showAllSessions: "Show all dates",
    sessionsUnit: "sessions",
    upcomingLeft: "upcoming",
    seatsTotal: "seats booked across all dates",
  },
  th: {
    title: "คลาส",
    ...
    sat: "ส",
    goBack: "กลับ",
    repeatsWeekly: "ซ้ำทุกสัปดาห์",
    nextSession: "รอบถัดไป",
    showAllSessions: "ดูทุกวัน",
    sessionsUnit: "รอบ",
    upcomingLeft: "ที่ยังไม่ถึง",
    seatsTotal: "ที่นั่งที่จองแล้วรวมทุกรอบ",
  },
};
...
export const resourcesText: Record<Locale, Record<string, string>> = {
  en: {
    ...
    goBack: "Go back",
    working: "Saving…",
    closeRoomTitle: "Close this room temporarily?",
    closeRoomDesc: "It won't be offered for new class sessions until you reopen it. Sessions and bookings already scheduled here stay as they are.",
    reopenRoomTitle: "Reopen this room?",
    reopenRoomDesc: "It will be available again when scheduling new class sessions.",
  },
  th: {
    title: "ห้อง",
    ...
    goBack: "กลับ",
    working: "กำลังบันทึก…",
    closeRoomTitle: "ปิดห้องนี้ชั่วคราวหรือไม่?",
    closeRoomDesc: "ห้องนี้จะเลือกไม่ได้ตอนตั้งรอบคลาสใหม่จนกว่าจะเปิดอีกครั้ง รอบคลาสและการจองที่มีอยู่แล้วในห้องนี้ไม่เปลี่ยนแปลง",
    reopenRoomTitle: "เปิดห้องนี้อีกครั้งหรือไม่?",
    reopenRoomDesc: "ห้องนี้จะกลับมาเลือกได้ตอนตั้งรอบคลาสใหม่",
  },
};
